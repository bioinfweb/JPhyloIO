...
public class NoAnnotationsNetwork extends StoreTreeNetworkDataAdapter implements TreeNetworkDataAdapter {	
	...
	public NoAnnotationsNetwork(String id, String label, String nodeEdgeIDPrefix, String[] linkedOTUs) {
	...
	public NoAnnotationsNetwork(String id, String label, String nodeEdgeIDPrefix) {
