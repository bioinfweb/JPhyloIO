...
public class MultipleRootEdgesTree extends EmptyAnnotatedDataAdapter<LabeledIDEvent> implements TreeNetworkDataAdapter  {
	...
	public MultipleRootEdgesTree(String id, String label, String nodeEdgeIDPrefix, String... linkedOTUs) {
		super();
		this.id = id;
		this.label = label;
	...
	public MultipleRootEdgesTree(String id, String label, String nodeEdgeIDPrefix) {
	...
	public EdgeEvent getEdgeStartEvent(String edgeID) {
		if (edgeID.startsWith(nodeEdgeIDPrefix)) {
			switch (edgeID.substring(nodeEdgeIDPrefix.length())) {
				case "eRoot1":
					return new EdgeEvent(edgeID, "Root edge1", null, nodeEdgeIDPrefix + "nRoot", 1.5);
				case "eRoot2":
					return new EdgeEvent(edgeID, "Root edge2", null, nodeEdgeIDPrefix + "n1", 0.7);
				case "e1":
