...
public abstract class ApplicationReader implements IOConstants {
	protected abstract RelatedResource readRelatedResource(JPhyloIOEventReader reader) throws IOException;
	
	
	public void read(JPhyloIOEventReader reader, List<RelatedResource> resources) throws IOException {
