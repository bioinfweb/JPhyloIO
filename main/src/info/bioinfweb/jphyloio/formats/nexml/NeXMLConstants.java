...
public interface NeXMLConstants {
	...
	public static final String ALIGNMENT_TYPE_DNA = "DNA data";
	public static final String ALIGNMENT_TYPE_RNA = "RNA data";
	public static final String ALIGNMENT_TYPE_AA = "Amino acid data";
	public static final String ALIGNMENT_TYPE_CONTINUOUS = "Continuous data";
	public static final String ALIGNMENT_TYPE_RESTRICTION = "Restriction site data";
	public static final String ALIGNMENT_TYPE_STANDARD = "Standard data";
