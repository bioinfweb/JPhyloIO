...
//				getStreamDataProvider().getMatrixLink()));  // Will link null if no CHARACTERS, DATA or UNALIGNED block was defined before.  //TODO Should an exception be thrown instead?  //TODO Sets for UNALIGNED blocks are not allowed according to the Nexus paper. (Is it a problem to support them anyway?)
//	}
//	
//	
...
//				getStreamDataProvider().getCurrentEventCollection().add(new PartEndEvent(EventContentType.CHARACTER_SET, true));  // Empty character sets are not valid in Nexus but are anyway supported here.
//				return true;
//			}
//			else {
