...
public class JPhyloIO {
	...
	private static final ApplicationVersion VERSION = new ApplicationVersion(0, 5, 2, 1609, ApplicationType.ALPHA);  //TODO Set to beta with next increase of minor version number.
